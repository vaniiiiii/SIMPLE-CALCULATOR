...
button_delete=Button(root,text="del",padx=40,pady=20,command=button_delete())
...
button_equal=Button(root,text="equal",padx=40,pady=20,command=lambda:button_equal())
